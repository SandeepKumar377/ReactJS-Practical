...
function App() {
  ...
  const toastDemo=()=>{
    ...
    toast.success('Success Notification!', {position: toast.POSITION.TOP_CENTER, autoClose:3000})
    ...
    toast('Basic Notification!', {position: toast.POSITION.TOP_LEFT, autoClose:false})
  }
